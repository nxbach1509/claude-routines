...
1. "thị trường căn hộ chung cư tuần này {date_str}" HOẶC "bất động sản nhà ở tháng 5 {year_str}"
...
def build_prompt(session: dict, date_str: str, year_str: str | None = None) -> str:
