...
1. "thị trường căn hộ chung cư tuần này {date_str}" HOẶC "bất động sản nhà ở {month_vi}"
2. "Savills CBRE JLL Vietnam residential market {quarter}"
...
2. "Savills CBRE JLL Vietnam hospitality market {quarter}"
...
2. "office market Ho Chi Minh Hanoi {quarter} net absorption"
...
11. "CBRE JLL Savills office retail outlook Vietnam {quarter} report"
...
• **Báo cáo CBRE/JLL/Savills {quarter}:** [Key findings nếu đã phát hành]
...
2. "Savills CBRE JLL Vietnam industrial market {quarter}"
...
1. [Shift: Labor-cost advantage → Ecosystem advantage]
   Bằng chứng: [...] | Dự báo {year}–{year_plus4}: [...]
