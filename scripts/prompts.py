...
# ---------------------------------------------------------------------------
_COMMON_PREAMBLE = """\
Hôm nay là {thu_str}, {date_str} (giờ Việt Nam). Năm hiện tại: {year}.
...
2. "Savills CBRE JLL Vietnam residential market {year}"
...
2. "Savills CBRE JLL Vietnam hospitality market {year}"
...
6. "căn hộ dịch vụ serviced apartment quy định pháp lý Vietnam {year}"
...
2. "office market Ho Chi Minh Hanoi {year} net absorption"
...
6. "retail tenant mix F&B fashion entertainment mall Vietnam {year}"
...
2. "Savills CBRE JLL Vietnam industrial market {year}"
...
def build_prompt(session: dict, date_str: str, year: int) -> str:
