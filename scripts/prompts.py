...
1. "thị trường căn hộ chung cư tuần này {date_str}" HOẶC "bất động sản nhà ở {month_year_str}"
2. "Savills CBRE JLL Vietnam residential market {quarter_str}"
...
2. "Savills CBRE JLL Vietnam hospitality market {quarter_str}"
...
(2) Phân khúc có cơ hội tốt nhất 12–24 tháng tới: [budget/lifestyle/luxury/wellness/\
...
2. "office market Ho Chi Minh Hanoi {quarter_str} net absorption"
...
11. "CBRE JLL Savills office retail outlook Vietnam {quarter_str} report"
...
• **Báo cáo CBRE/JLL/Savills {quarter_str}:** [Key findings nếu đã phát hành]
...
2. "Savills CBRE JLL Vietnam industrial market {quarter_str}"
...
def build_prompt(session: dict, date_str: str) -> str:
    ...
    quarter_str = f"Q{quarter} {year_str}"
    month_year_str = f"tháng {dt.month} {year_str}"
