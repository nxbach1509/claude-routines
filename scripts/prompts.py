...
# ---------------------------------------------------------------------------
_COMMON_PREAMBLE = """\
Hôm nay là {thu_str}, {date_str} (giờ Việt Nam). Năm hiện tại: {year_str}.
...
6. "Quyết định 26 TPHCM căn hộ dịch vụ {year_str}"
...
• **Báo cáo McKinsey "Future of Asia Manufacturing" / BCG industrial RE {year_str}:** \
