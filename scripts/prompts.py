...
2. "Savills CBRE JLL Vietnam residential market Q1 {year}"
...
2. "Savills CBRE JLL Vietnam hospitality market Q1 {year}"
...
6. "Quyết định 26/2025 TPHCM căn hộ dịch vụ triển khai {year}"
...
2. "office market Ho Chi Minh Hanoi Q1 {year} net absorption"
...
11. "CBRE JLL Savills office retail outlook Vietnam Q1 {year} report"
...
2. "Savills CBRE JLL Vietnam industrial market Q1 {year}"
...
def build_prompt(session: dict, date_str: str) -> str:
    ...
    year = date_str.split("/")[-1]  # "DD/MM/YYYY" → "YYYY"
